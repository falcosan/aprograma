...
<template>
  <div v-if="layout.content.maintenance" class="aprograma-maintenance h-screen flex flex-col justify-center p-5">
  ...
  <div v-else class="aprograma-theme">
    <component :is="resolveComponent(component.component)" v-for="component in layout.content.body"
      :key="component._uid" :blok="component">
      <template #header>
