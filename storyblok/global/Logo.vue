<template>
  <div class="logo-container">
    <svg key="logo" ref="logo" :style="`height: ${blok && blok.size ? blok.size : size ? size : 'auto'}; width: ${blok && blok.size ? blok.size : size ? size : 'auto'
      };`" class="logo cursor-pointer max-w-full max-h-full mx-auto my-0" version="1.1" baseProfile="basic"
      xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="710.8732px"
      height="710.8732px" viewBox="0 0 710.8732 710.8732" xml:space="preserve"
      @click="blok?.transition || transition ? play() : null">
      <g :class="`transition-logo logo-a ${moved.a}`">
        <path :fill="blok && blok.color_a.color ? blok.color_a.color : colorA ? colorA : '#999999'" d="M255.8788,165.9017c-83.6324,0-151.4281,69.7552-151.4281,153.3876
        ...
        <path :fill="blok && blok.color_a.color ? blok.color_a.color : colorA ? colorA : '#999999'" d="M362.7918,472.2758h-15.7596c-24.4153,0-44.2078-19.7925-44.2078-44.2079V208.5204
      ...
      <g :class="`transition-logo logo-p ${moved.p}`">
        <path :fill="blok && blok.color_p.color ? blok.color_p.color : colorP ? colorP : '#000000'" d="M606.4182,314.8502c-1.7396-92.0206-73.0146-151.8879-149.2385-151.878c-25.4046,0-51.3691,6.6486-75.4841,20.9756
