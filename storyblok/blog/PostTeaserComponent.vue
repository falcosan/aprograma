  ...
  <li v-if="postContent" class="post-teaser w-full overflow-hidden rounded">
    <NuxtLink :to="`${blogRoute}${postLink}`" class="teaser-link">
      ...
      >
        ...
        >
          <component
            :is="postContent.file.filename ? lookFile : 'ImageSet'"
            :loading="checkFile"
            ...
            :sizes="
              checkFile
                ? 'xs:299px sm:380px md:514px lg:620px xl:984px 2xl:1200px'
                : false
            "
          />
        </div>
        <div
          ...
          :style="`background-color: ${
            postContent.background_color.color
              ? postContent.background_color.color
              : '#e0e0e0'
        ...
        >
          ...
          <ul
            class="teaser-categories w-full flex flex-wrap lg:flex-nowrap -mx-1 overflow-x-auto"
          >
            <li
